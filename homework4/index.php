<?php
    ...
    $phone = 89437192108;
    $skills = [
    'name' => ['Photoshop', 'Photography','Illustrator','Media'],
    'level' => [90,80,75,50]
    ];
    $experience = [
...
','Graphic Designer / designsomething.com'],
    'data' =>['Jan 2015','Mar 2012 - Dec 2014','Jun 2010 - Mar 2012'],
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['data'][0]?> - <span class="w3-tag w3-teal w3-round">Current</span></h6>
          <p><?php echo $experience['desc'][0]?>.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['post'][1]?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['data'][1]?></h6>
          <p><?php echo $experience['desc'][1]?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['post'][2]?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['data'][2]?></h6>
          <p><?php echo $experience['desc'][2]?> </p><br>
        </div>
      </div>
